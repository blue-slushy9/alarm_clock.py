...
# This function will convert the alarm_time user input into a datetime object, 
# to be stored in the global variable alarm_time2;    
...
# This if statement will cover PM times;
    ...
    # format; also, the alarm_execution function is nested inside of 
    # pm_time_conversion, otherwise we would not be able to pass the modified 
    # alarm_time as it is a local variable;
